...
function runBaseTests() {
  px_demo_snippet_1 = document.getElementById('px_demo_snippet_1');

  suite('Base Automation Tests for px-demo-snippet', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-demo-snippet fixture is created', function() {
      assert.isTrue(document.getElementById('px_demo_snippet_1') !== null);
    });
